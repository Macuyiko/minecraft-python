...
public class JyHTTPServer {
	...
	public JyHTTPServer(int port, String homeDir) throws IOException {
		this.myTcpPort = port;
	...
	public static void start(int port, String homeDir) {
		try {
			new JyHTTPServer(port, homeDir);
		} catch (IOException ioe) {
			ioe.printStackTrace();
		}
	}
	...
	public Response serve(String uri, String method, Properties header, Properties parms, Properties files) {
		...
		return serveFile(uri, header, new File(homeDir), true);
	}
	...
	public static final String LICENCE = "Copyright (C) 2001,2005-2011 by Jarno Elonen <elonen@iki.fi>\n"
